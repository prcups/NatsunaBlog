    ...
    <div>
        <div v-if="isChecked">
            <div style="min-height: 80vh">
                ...
                <br>
                <mavon-editor v-model="post.content" ref="md" style="min-height: 60vh" @imgAdd="$imgAdd" @imgDel="$imgDel"></mavon-editor>
            </div>
        ...
        methods: {
            $imgAdd(pos, $file){
                ...
                axios({
                    ...
                    let imageUrl = url.GetImageBaseUrl + "/" + res.data.name
