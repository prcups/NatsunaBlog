    ...
    <div v-if="isChecked">
      ...
      <b-input-group style="margin-top: 1vh;" >
        ...
        <b-input-group-append>
          <b-form-checkbox button :checked="post.ontop" @input="post.ontop = $event" value="1" :unchecked-value="0">置顶</b-form-checkbox>
          <b-form-checkbox button :checked="post.hid" @input="post.hid = $event" value="1" :unchecked-value="0">隐藏</b-form-checkbox>
        </b-input-group-append>
      </b-input-group>
